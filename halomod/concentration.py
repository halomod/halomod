...
class CMRelation(Component):
    ...
    def __init__(self, filter0=None, mean_density0=None, growth=None, delta_c=1.686,
                 profile=None, cosmo=None, delta_halo=200.0, mdef='200c',
                 **model_parameters):
...
class Ludlow2016Empirical(CMRelation):
    ...
    def cm(self, m, z):
        ...
        nu = self.delta_c / sig
        return self._c0(z) * (nu / self._nu_0(z)) ** (-self._gamma1(z)) * (
                    1 + (nu / self._nu_0(z)) ** (1. / self._beta(z))) ** (
